...
ImageGuidedFMDirection_Adam_reference_run = 'python reference.py ' \
                                            '--gpu {gpu} ' \
                                            '--adv_path Image-ImageGuidedFMDirection_Adam-{step}-resnet_step_size_{step_size}_paper_study'
...
if __name__ == '__main__':
    args = arg_parse()
    # ablation study for step size and iteration number (Figure 4.12)
    ...
    # ablation study for attacked layer (Table 4.8 and Figure 4.13)
    depths = [1,2,3,4]
    ...
    # performance comparison for kinetics-400 (Table 4.2)
    step = 60
    step_size = 0.005
