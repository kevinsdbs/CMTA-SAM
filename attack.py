...
def arg_parse():
    ...
    parser.add_argument('--model', type=str, default='i3d_resnet101',
                        help='i3d_resnet101 | i3d_slow_resnet101 | slowfast_resnet101 | tpn_resnet101.')
    parser.add_argument('--attack_method', type=str, default='TemporalTranslation',
                        help='FGSM | BIM | MIFGSM | DIFGSM | TIFGSM | SGM')
    ...
    parser.add_argument('--iterative_momentum', action='store_true', default=False,
                        help='Use iterative momentum in MFFGSM.')
    ...
    if args.attack_type == 'video':
        args.adv_path = os.path.join(OPT_PATH,
                                     '{}-{}-{}-{}'.format(args.model, args.attack_method, args.step, args.file_prefix))
...
if __name__ == '__main__':
    ...
    if args.attack_type == 'image':
        ...
        if args.attack_method == 'TemporalTranslation':
            spe_params = {'kernlen': args.kernlen, 'momentum': args.iterative_momentum,
                          'weight': args.augmentation_weight, 'move_type': args.move_type,
