...
CONFIG_ROOT = '/root/autodl-tmp/pythonProjectCMTA-SAM/CMTA-SAM-attack/config'  # <need to specify>
CONFIG_PATHS = {
...
# data info
UCF_IMAGE_ROOT = './Dataset-ucf101'   # <need to specify>

# save info
# OPT_PATH = 'D:/CSMA-SAMOpt-path'  # <need to specify>
OPT_PATH = '/root/autodl-tmp/CSMA-SAMOpt-path'  # <need to specify>

UCF_DATA_ROOT = './Dataset-ucf101'   # ucf101 dataset path

# checkpoints path for ucf101
UCF_CKPT_PATH = './Checkpoint'  # <need to specify>

def change_cfg(cfg, batch_size, random):
    # modify video paths and pretrain setting.
    # cfg.CONFIG.DATA.VAL_DATA_PATH = './Dataset-kinetics'  # <need to specify>
    # cfg.CONFIG.DATA.VAL_ANNO_PATH = './kinetics400_attack_samples.csv'  # selected 400 classified correct.
    cfg.CONFIG.DATA.VAL_DATA_PATH = '/root/autodl-tmp/pythonProjectCMTA-SAM/CMTA-SAM-attack/Dataset-kinetics'  # <need to specify>
    cfg.CONFIG.DATA.VAL_ANNO_PATH = '/root/autodl-tmp/pythonProjectCMTA-SAM/CMTA-SAM-attack/kinetics400_attack_samples.csv'  # selected 400 classified correct.
